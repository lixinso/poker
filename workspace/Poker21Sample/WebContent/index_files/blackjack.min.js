		...
		.ready(
				function() {
					...
					function hud() {
						...
						$('a.Chip').animate({
							scale : ns
								...
								function(e) {
									if (GAME.clearing == false && !GAME.playing
											&& !GAME.dealing && !GAME.hitting) {
					...
					function deck() {
						...
						$('#Shoe')
								.prepend(
										'<div id="Deck" style="margin-top:'
												+ (-n)
												+ 'px; padding-top:'
												+ (n)
												+ 'px"><div class="Card"><div class="Flip"><div class="Front"><div></div></div></div>')
						var c = $('#Shoe .Card')
					...
					function payout(entity, amount) {
						...
						p.fadeIn(250, function() {
							...
							for ( var c = 0; c < chips.length; c++) {
								var chip = chips[c]
								p.append('<span class="ChipSm ' + chip
										+ '"></span>')
					...
					function doubledown(entity) {
						$('#Player').find('.Wager .ChipSm').each(
								function() {
									bet($('#Player'), $(this).attr('class')
											.split(' ')[1])
								})
						setTimeout(function() {
							if (GAME.hitting == false) {
					...
					function setcash(c) {
						...
						if (c != 0) {
							var cc = GAME.cash
							$('#Cash').append(
									'<span class="PlusMinus">' + a + c
											+ '</span>')
							GAME.cash = (cc + c)
							$('#Cash .PlusMinus').first().fadeOut(0).fadeIn(
									75,
									function() {
										var t = $(this)
										setTimeout(function() {
					...
					function checkactions(entity) {
						...
						if (h) {
							if (h.length == 2) {
								var c1 = $('#' + h[0]).find('.Back').attr(
										'class').split(' ')[2]
								var c2 = $('#' + h[1]).find('.Back').attr(
										'class').split(' ')[2]
								if (c1 == 'King' || c1 == 'Queen'
										|| c1 == 'Jack' || c1 == 'Ten') {
									c1 = 'Face'
